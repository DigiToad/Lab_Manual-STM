...
/* USER CODE BEGIN PV */
float mic=0.0;
float mic_buffer[DATA_INPUT_USER*AXIS_NUBMER]={0};
...
void Log()
{
    ...
    for(int i=0; i<DATA_INPUT_USER; i++)
    {
    	printf("%.2f",mic_buffer[AXIS_NUBMER*i]);
    	printf(" ");
    }
	printf("\r\n");
}
